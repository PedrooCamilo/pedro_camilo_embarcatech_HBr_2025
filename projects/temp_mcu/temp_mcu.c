// o código teve como base o exemplo disponibilizado no EBOOK
...
// Função para converter o valor lido do ADC diretamente para temperatura em graus Celsius
float adc_to_temperature(uint16_t adc_value) {
    ...
    // Fórmula para Celsius (diretamente do datasheet)
...
int main() {
    ...
    while (true) {
        // Lê o valor do ADC no sensor de temperatura
